...
ElGamal encryption in $\mathcal{F}^{*}_p$. The security of the
Boneh-Frenkel scheme is analogues to the computational Diffie-Hellman assumption,
...
%% [20, 22] + distributed master key mechanism



We discuss key revocation, as well as several new
