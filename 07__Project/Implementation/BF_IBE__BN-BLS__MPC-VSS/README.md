# Boneh-Franklin based IBE using OTATE pairing with MPC-VSS (work in progress...)
...
__EASY-INSTALL__: Add `.jar` files under `/src/main/resources/jars/../` then Right-Click
_Add as library__.
...
Build instructions can be found at: https://github.com/relic-toolkit/relic/wiki/Building
```bash
# Install prerequisite packages
sudo dnf install cmake gmp gmp-ecm gmp-static llvm19

# Download and untar relic source
