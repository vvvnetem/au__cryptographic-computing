 ...
 *
 * Notation for variable names are based on the following scheme:
...
public class Bob {
    ...
    // OT helper against Malicious Party member
    public final MaliciousElGamalOT ot;

    public Bob() throws Exception {
        sha256 = MessageDigest.getInstance("SHA-256");
        // use malicious-resilient OT
        ot = new MaliciousElGamalOT(512);
    }
    ...
    public MaliciousElGamalOT.SenderOutput respondToOT(byte[] s0, byte[] s1, java.math.BigInteger beta0, java.math.BigInteger beta1, java.math.BigInteger C) throws Exception {
