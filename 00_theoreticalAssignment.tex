...
%% TTP
\subsection{Description of the function $f$ as a truth table}
...
\subsection*{ Compatibility matrix using 3-bit representation }
...
\subsection*{Simplified boolean formula $f$}
\begin{itemize}
...
Finally we are able to check our formalization. (Please note, the $_{*}$ used as a placeholder for modifier $+,-$)
